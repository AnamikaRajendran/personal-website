        ...
        <div className="z-10 max-w-screen-lg w-full">
          <div className="flex flex-col items-center gap-y-6 rounded-xl bg-gray-800/40 p-6 text-center shadow-lg backdrop-blur-sm max-w-full break-words">
            <p
              ...
              role="img">
              <span className="inline-block mr-1">👩‍💻</span> <span className="text-green-500">&lt;code&gt;</span> I
              develop pretty things - glad you stopped by ;). <span className="text-green-500">&lt;/code&gt;</span>
            </p>
            <h1 className="text-4xl font-bold text-white sm:text-5xl md:text-6xl lg:text-7xl break-words">{name}</h1>
