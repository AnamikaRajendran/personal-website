    ...
    <Section className="bg-white text-black" noPadding sectionId={SectionId.Achievements}>
      <div
        className={classNames(
          'flex w-full items-center justify-center px-4 py-16 md:py-24 lg:px-8 bg-white'
        )}
      >
        <div className="z-10 w-full max-w-6xl px-4 lg:px-0">
          {/* Main container modal with darker grey shade */}
          <div className="flex flex-col items-center gap-y-6 rounded-xl bg-neutral-800 p-6 shadow-lg">
            ...
            <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
              ...
              <div className="rounded-xl overflow-hidden shadow-lg bg-neutral-700 hover:shadow-orange-400 transition-all duration-300">
                <div className="relative w-full h-72 overflow-hidden group p-2 bg-black rounded-xl">
